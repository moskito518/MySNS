...
<div class="box">
   <div class="title">
      ...
      <ul class="links">
         <li><?php echo anchor('system/option/site_config_add', '添加新配置'); ?></li>
      </ul>
   </div>
   <?php echo form_open('system/option/site_config_all_del'); ?>
      <div class="table">
         <table>
            <col width="15%" />
            <col width="13%" />
            ...
            <?php foreach($configData as $configItem):?>
               <tr>
                  ...
                  <td class="operation">
                     <?php echo anchor('system/option/site_config_edit/' . $configItem['id'], '［编辑］');?>
					 <a href="javascript:void(0);" onclick="delModel('<?php echo site_url('system/option/site_config_del/'.$configItem['id']); ?>');">删除</a>
                  </td>
                  <td class="last">
