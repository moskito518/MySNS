...
<div class="box">
   ...
   <div class="form">
      <?php echo form_open('system/article/create'); ?>
         <div class="fields">
           <div class="field">
              <div class="label">
              ...
              <div class="input">
                 <input type="text" class="small" value="<?php echo set_value('title'); ?>" id="title" name="title" />
           ...
           <div class="field">
              ...
              <div class="select">
              	<select class="auto" name="category" id="category">
					...
					<option value="<?php echo $category_item['id']?>" <?php echo set_select('category', $category_item['id'])?>><?php echo $path_length == 0 ? $category_item['title'] : str_repeat('&nbsp;&nbsp;&nbsp;&nbsp;', $path_length) . '└' . $category_item['title']; ?></option>
					<?php endforeach; ?>
              	</select>
           ...
           <div class="field">
              ...
              <div class="textarea textarea-editor">
				<textarea name="content" id="text_content" style="height:300px;width:600px"><?php echo set_value('content'); ?></textarea>
