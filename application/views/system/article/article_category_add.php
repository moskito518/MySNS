...
<div class="box">
   ...
   <div class="form">
      <?php echo form_open('system/article_category/create'); ?>
         <div class="fields">
           <div class="field">
              <div class="label">
           ...
           <div class="field">
              ...
              <div class="select">
              	<select name="parent" id="parent">
					...
					<option value="<?php echo $category_item['id']; ?>" <?php echo set_select('parent', $category_item['id'])?>><?php echo $path_length == 0 ? $category_item['title'] : str_repeat('&nbsp;&nbsp;&nbsp;&nbsp;', $path_length) . '└' . $category_item['title']; ?></option>
					<?php endforeach ?>
				</select>
		   ...
		   <div class="field">
              ...
              <div class="input">
      			 <input type="text" class="small" name="order" id="order" value="<?php echo set_value('order'); ?>" />
           ...
           <div class="field">
              ...
              <div class="textarea">
      			 <textarea id="textarea1" name="description" style="width: 350px;height: 150px;"><?php echo set_value('description'); ?></textarea>
